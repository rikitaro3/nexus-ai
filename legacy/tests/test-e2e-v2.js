  ...
  try {
    ...
    if (errors.length > 0) {
      ...
      if (logs.some(log => log.includes('ENOENT') && log.includes('context.mdc'))) {
        ...
        console.log('   Suggestion: Check if context.mdc exists');
        console.log('   Command: ls context.mdc');
      }
...
### PRD
- docs/PRD/index.mdc … PRD Index
- docs/PRD/PRD_Nexus.mdc … Nexus要件
- docs/PRD/PRD_DocumentTemplate.mdc … ドキュメントテンプレート
- docs/PRD/PRD_DocsNavigator_TasksBreakdown.mdc … Docs Navigator + Tasks

### ARCH
- docs/ARCH/index.mdc … アーキテクチャIndex

### DEVELOPMENT
- docs/DEVELOPMENT/index.mdc … 開発ガイド

### QA
- docs/QA/index.mdc … QA Index
- docs/QA/E2Eテスト実行方法.mdc … E2Eテスト実行方法

### GATES
- docs/GATES/document.mdc … Document Quality Gates

### Root
- docs/index.mdc … Nexus Docs Root
